 ...
 */
final class Version20241125182254 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE enchere (id INT AUTO_INCREMENT NOT NULL, le_produit_id INT DEFAULT NULL, titre VARCHAR(255) NOT NULL, date_heure_debut DATETIME NOT NULL, date_heure_fin DATETIME NOT NULL, prix_debut DOUBLE PRECISION NOT NULL, statut VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_38D1870F2C340150 (le_produit_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE participation (id INT AUTO_INCREMENT NOT NULL, le_user_id INT DEFAULT NULL, la_enchere_id INT DEFAULT NULL, prix_encheri DOUBLE PRECISION NOT NULL, budget_maximum DOUBLE PRECISION NOT NULL, INDEX IDX_AB55E24F88A1A5E2 (le_user_id), INDEX IDX_AB55E24FC80D2A2F (la_enchere_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE produit (id INT AUTO_INCREMENT NOT NULL, la_enchere_id INT DEFAULT NULL, libelle VARCHAR(255) NOT NULL, description VARCHAR(255) NOT NULL, prix_plancher DOUBLE PRECISION NOT NULL, UNIQUE INDEX UNIQ_29A5EC27C80D2A2F (la_enchere_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
